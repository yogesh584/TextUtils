...
export default function Navbar(props){
    ...
    return (
        ...
        <ul className='flex gap-8'>
          <li><Link to="/" className={`text-${props.mode === 'light'?'black' : '#fff'} transition duration-200`}>Home</Link></li>
          <li><Link to="/" className={`text-${props.mode === 'light'?'black' : '#fff'} transition duration-200`}>Shop</Link></li>
          <li><Link to="/about" className={`text-${props.mode === 'light'?'black' : '#fff'} transition duration-200`}>{props.about}</Link></li>
          <li><Link to="/" className={`text-${props.mode === 'light'?'black' : '#fff'} transition duration-200`}>Contact</Link></li>
        </ul>
